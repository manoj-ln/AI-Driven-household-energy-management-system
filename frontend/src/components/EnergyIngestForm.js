...
const DATASET_OPTIONS = [
  { value: "energy_dataset_50k_plus.csv", label: "Energy 50k+ Dataset (2 months)" },
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "18px" }}>
            <button
              ...
              style={{ background: "transparent", border: "none", color: "#3b82f6", cursor: "pointer", fontWeight: 600, padding: 0 }}
            >
          ...
          {showAdvanced && (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "16px", marginBottom: "24px", padding: "16px", background: "#f8fafc", borderRadius: "12px", border: "1px solid #e2e8f0" }}>
              <div className="form-group" style={{ marginBottom: 0 }}>
                <label className="form-label" style={{ fontSize: "0.9rem" }}>Historical Context</label>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                <label className="form-label" style={{ fontSize: "0.9rem" }}>Reference Dataset</label>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                <label className="form-label" style={{ fontSize: "0.9rem" }}>Prediction Mode</label>
                <select value={predictionMode} onChange={(event) => setPredictionMode(event.target.value)} className="form-input">
                  <option value="blend">Blend (Manual + History + Dataset)</option>
                  <option value="dataset">Dataset-Led</option>
                  <option value="forecast">Forecast-Led</option>
                  <option value="manual">Manual Plan Only</option>
                </select>
              </div>
              <div className="form-group" style={{ marginBottom: 0 }}>
                <label className="form-label" style={{ fontSize: "0.9rem" }}>Forecast Horizon</label>
                <select value={forecastWindow} onChange={(event) => setForecastWindow(event.target.value)} className="form-input">
                  <option value="60_seconds_csv">60 Seconds Pulse (Simulation)</option>
        ...
        <div style={{ marginTop: "24px", padding: "18px", background: "linear-gradient(180deg, #ffffff 0%, #eef6ff 100%)", borderRadius: "16px", border: "1px solid #d9e8f7" }}>
          ...
          {forecastWindow === "60_seconds_csv" ? (
            <div style={{ marginTop: "18px", padding: "16px", borderRadius: "16px", background: "#ffffff", border: "1px solid #dbe8f6" }}>
              <h5 style={{ marginTop: 0, color: "#0f4c81" }}>
                Second-Wise Device Pulse From {DATASET_OPTIONS.find((item) => item.value === datasetSource)?.label || datasetSource}
              </h5>
              <p style={{ marginTop: 0, color: "#5d6778", lineHeight: 1.6 }}>
